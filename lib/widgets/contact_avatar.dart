...
class ContactAvatar extends StatelessWidget {
  ...
  const ContactAvatar({super.key, required this.name, this.radius = 22, this.photoUri, this.heroTag});

  static const List<Color> _palette = [Color(0xFF1A73E8), Color(0xFF34A853), Color(0xFFFBBC04), Color(0xFFEA4335), Color(0xFF8430CE), Color(0xFF00897B), Color(0xFFE91E63), Color(0xFFFF6D00)];
  ...
  Widget build(BuildContext context) {
    ...
    if (photoUri != null && photoUri!.isNotEmpty) {
      ...
      avatar = CircleAvatar(
        ...
        child: Text(
          initials,
          style: TextStyle(color: color, fontWeight: FontWeight.w600, fontSize: radius * 0.7),
        ),
      );
    }
