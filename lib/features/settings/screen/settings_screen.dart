...
import '../../recordings/screen/recordings_screen.dart';
...
class _SettingsScreenState extends State<SettingsScreen> {
                ...
                child: _buildGroupedCard(
                  ...
                  [
                    ...
                    _buildTile(
                      ...
                      title: 'Video calling',
                      subtitle: 'Carrier video calling & default app',
                      onTap: () {
                        // Show a simple dialog or bottom sheet for video call settings
                        _showVideoCallSettings();
                      },
                    ),
                  ],
                ),
                    ...
                    _buildGroupedCard(
                      ...
                      [
                        ...
                        _buildTile(
                          ...
                          title: 'Custom recording path',
                          subtitle: 'Tap to enter custom storage path',
                          onTap: () {
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            ListTile(
              leading: Icon(Icons.radio_button_checked_rounded, color: cs.primary),
              title: const Text('Google Meet (Default)'),
              subtitle: const Text('Use Meet for video calls'),
              onTap: () => Navigator.pop(context),
            ),
            ListTile(
              leading: Icon(Icons.radio_button_unchecked_rounded, color: cs.onSurfaceVariant),
              title: const Text('Carrier video calling'),
              subtitle: const Text('Use network provided video calling'),
              onTap: () => Navigator.pop(context),
            ),
            const SizedBox(height: 8),
          ],
  ...
  void _showCustomPathDialog() async {
    final service = getIt<RecordingService>();
    final currentPath = await service.customRecordingPath;
    ...
    showDialog(
      ...
      builder: (_) {
        return AlertDialog(
          title: const Text('Custom Recording Path'),
          content: TextField(
            controller: ctrl,
          ...
          actions: [
            ...
            FilledButton(
              onPressed: () {
                service.setCustomRecordingPath(ctrl.text.trim());
                Navigator.pop(context);
                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Recording path updated')));
              },
